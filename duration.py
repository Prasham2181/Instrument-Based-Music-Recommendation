...
def get_instrument_duration_percentage(file_path):
        ...
        try:
            ...
            # Return the percentage of non-silent duration
            return np.round((non_silent_duration / total_duration), 3)
        
        except Exception as e:
            print(f"Error processing {file_path}: {e}")
            return 0.0

def calculate_duration_matrix(test_folder, instruments, output_npy):
...
def main():
    # Parameters
    test_folder = r'C:\Users\sonip\Desktop\Playing with Pytorch\DL_Project\Track00001'  # Path to track folders
    instruments = ['Guitar', 'Bass', 'Piano', 'Drum', 'Others']  # List of instruments
    output_npy = r'C:\Users\sonip\Desktop\Playing with Pytorch\DL_Project\instrument_durations_percentage.npy'

    # Call the function to calculate the matrix
    duration_matrix = calculate_duration_matrix(test_folder, instruments, output_npy)
